    ...
    <div class="doctor_sidebar">
            ...
            <div class="pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="appointmet.html">
                    ...
                    <li class="nav-item mt-4" onclick="logoutPatient()">
                        <a class="nav-link" href="#" onclick="logoutPatient()">
    ...
    <div class="topbar d-flex justify-content-between align-items-center">
              ...
              <a class="nav-link" href="patientprofile.html">
                    <div class="user-profile d-flex align-items-center">
                        <img src="" alt="Doctor" id="patientImage">
                        <div class="ms-2">
                            <div class="fw-bold"> <span id="firstName"></span><span id="lastName"></span></div>
